            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3>แบบฟอร์มแก้ไขข้อมูลนักศึกษา</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-edit" role="tabpanel" aria-labelledby="pills-edit-tab">
                                <form action="services/student_update.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6 col-12 text-center">
                                            <img src="assets/images/users/<?= $data->std_image ?>" width="225" height="250">
                                            <input type="text" class="form-control" name="old_image" value="<?= $data->std_image ?>" readonly hidden>
                                            <input type="file" class="form-control" name="image" accept="image/*">
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <input type="text" class="form-control" name="id" value="<?= $data->std_id ?>" readonly hidden>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="gender">
                                                    <option value="ชาย" <?= ($data->std_gender == "ชาย") ? "selected" : "" ?>>ชาย</option>
                                                    <option value="หญิง" <?= ($data->std_gender == "หญิง") ? "selected" : "" ?>>หญิง</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>ปีการศึกษา</label>
                                                <input type="text" class="form-control" name="year" value="<?= $data->std_year ?>" required>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label>ที่อยู่</label>
                                            ...
                                            <div class="form-group">
                                                <label>อีเมล</label>
                                                <input type="email" class="form-control" name="email" value="<?= $data->std_email ?>" required>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="teacher" required>
                                                    <?php foreach ($tch_query as $row) { ?>
                                                        <option value="<?= $row['tch_id'] ?>" <?= ($row['tch_id'] == $data->tch_id) ? "selected" : "" ?>><?= $row['tch_firstname'] . " " . $row['tch_lastname'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="overseer" required>
                                                    <?php foreach ($ovs_query as $row) { ?>
                                                        <option value="<?= $row['ovs_id'] ?>" <?= ($row['ovs_id'] == $data->ovs_id) ? "selected" : "" ?>><?= $row['ovs_firstname'] . " " . $row['ovs_lastname'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <br>
                            ...
                            <div class="tab-pane fade" id="pills-editPass" role="tabpanel" aria-labelledby="pills-editPass">
                                <form action="services/student_update_password.php" method="post">
                            ...
                            <div class="tab-pane fade" id="pills-delete" role="tabpanel" aria-labelledby="pills-delete-tab">
                                <form action="services/student_delete.php" method="post">
                                    <p>*ยืนยันตัวตนผู้ดูแลระบบ</p>
                                    <input type="text" class="form-control" name="id" value="<?= $data->std_id ?>" readonly hidden>
                                    <div class="form-group">
                                        <label>รหัสผ่านของคุณ</label>
