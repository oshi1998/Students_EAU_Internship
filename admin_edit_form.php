            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3>แบบฟอร์มแก้ไขข้อมูลผู้ดูแลระบบ</h3>
                        <a href="admin_table.php">กลับหน้าตารางข้อมูล</a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-edit" role="tabpanel" aria-labelledby="pills-edit-tab">
                                <form action="services/admin_update.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6 col-12 text-center">
                                            <img src="assets/images/users/<?= $data->ad_image ?>" width="225" height="250">
                                            <input type="text" class="form-control" name="old_image" value="<?= $data->ad_image ?>" readonly hidden>
                                            <input type="file" class="form-control" name="image" accept="image/*">
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <input type="text" class="form-control" name="id" value="<?= $data->ad_id ?>" readonly hidden>
                                            <div class="form-group">
                                                <label>ชื่อจริง</label>
                                                <input type="text" class="form-control" name="firstname" value="<?= $data->ad_firstname ?>" required>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label>นามสกุล</label>
                                                <input type="text" class="form-control" name="lastname" value="<?= $data->ad_lastname ?>" required>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label>เพศ</label>
                                                <select class="form-control" name="gender">
                                                    <option value="ชาย" <?= ($data->ad_gender == "ชาย") ? "selected" : "" ?>>ชาย</option>
                                                    <option value="หญิง" <?= ($data->ad_gender == "หญิง") ? "selected" : "" ?>>หญิง</option>
                                                </select>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label>ที่อยู่</label>
                                                <textarea class="form-control" name="address" required><?= $data->ad_address ?></textarea>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label>เบอร์โทร</label>
                                                <input type="text" class="form-control" name="tel" value="<?= $data->ad_tel ?>" required>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <label>อีเมล</label>
                                                <input type="email" class="form-control" name="email" value="<?= $data->ad_email ?>" required>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-editPass" role="tabpanel" aria-labelledby="pills-editPass">
                                <form action="services/admin_update_password.php" method="post">
                            ...
                            <div class="tab-pane fade" id="pills-delete" role="tabpanel" aria-labelledby="pills-delete-tab">
                                <?php if ($_SESSION["AUTH_ID"] == $id) : ?>
                                    <p style="color:red;">ไม่สามารถลบข้อมูลตัวเองได้!</p>
                                <?php else : ?>
