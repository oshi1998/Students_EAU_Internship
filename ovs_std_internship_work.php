...
<?php
//คำสั่ง SQL
$sql = "SELECT * FROM students,internship_works WHERE students.std_id=internship_works.std_id AND internship_works.ovs_id='$ovs_id' ORDER BY intsw_date DESC";
                                ...
                                <tbody>
                                    <?php foreach ($query as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['intsw_ovs_status'] == "ยังไม่ได้รับการยืนยัน") : ?>
                                                    <a href="services/intsw_ovs_confirm.php?id=<?= $row['intsw_id'] ?>" onclick="return confirm('ยืนยันการอนุมัติ?')">อนุมัติ</a>
                                                <?php endif ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
